            ...
            <div class="container">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right">
                        <button class="btn btn-lg btn-danger"><i class="fa fa-times"></i> Batalkan</button>
                    </div>
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            <label for="nama-panggilan">Nama Belakang</label>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" value="" min="1" max="99" max-length="2" class="form-control" id="anak-ke" name="anak-dari" required>
                                                <div class="input-group-append">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" value="" min="1" max="99" max-length="2" class="form-control" id="saudara-kandung" name="saudara-kandung" required>
                                                <div class="input-group-append">
                                                    <div class="input-group-text"><i class="fa fa-asterisk"></i></div>
                                                </div>
                                                <div class="input-group-prepend">
                                                ...
                                                <input type="number" value="" min="1" max="99" max-length="2" class="form-control" id="saudara-tiri" name="saudara-tiri" required>
                                                <div class="input-group-append">
                                                ...
                                                <input type="number" value="" min="1" max="99" max-length="2" class="form-control" id="saudara-angkat" name="saudara-angkat" required>
                                                <div class="input-group-append">
                                                    <div class="input-group-text"><i class="fa ml-1 fa-asterisk"></i></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <select class="form-control select2" name="status-keluarga" id="status-keluarga"  style="width: 100%;" data-placeholder="Pilih Status..." required>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <small><i class="fa fa-info-circle"></i> Jika nama sekolah tidak ada, silahkan pilih 'Lainnya...'</small>
                                            <div class="input-group">
...
<script>
    $(document).ready(function () {
        grecaptcha.ready(function() {
            grecaptcha.execute('<?=getenv('CAPTCHA_KEYS')?>', {action:'validate_captcha'})
                    .then(function(token) {
